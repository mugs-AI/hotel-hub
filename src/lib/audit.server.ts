...
export type AuditEventType =
  ...
  | "hotel.reservation.update_failed"
  | "hotel.reservation.update_denied"
  | "hotel.reservation.guests_updated"
  | "hotel.reservation.primary_guest_changed"
  | "hotel.reservation.guest_correction"
  | "hotel.reservation.timeline_viewed"
